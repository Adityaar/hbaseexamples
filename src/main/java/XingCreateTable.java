...
public class XingCreateTable {
    public static void main(String args[]) throws IOException {
        ...
        try {
            ...
            HTableDescriptor tableName = new HTableDescriptor(TableName.valueOf("/tmp/xingdemo1"));
            tableName.addFamily(new HColumnDescriptor("message"));
            tableName.addFamily(new HColumnDescriptor("payload"));
            tableName.addFamily(new HColumnDescriptor("metadata"));
